	...
	public function render( $post ) {
		...
		<div class="wppseo-wrap">
			<div class="wppseo-tabs">
				<button type="button" class="wppseo-tab active" data-tab="general"><?php esc_html_e( 'General', 'wp-pilot-seo' ); ?></button>
				<button type="button" class="wppseo-tab" data-tab="social"><?php esc_html_e( 'Social', 'wp-pilot-seo' ); ?></button>
				<button type="button" class="wppseo-tab" data-tab="schema"><?php esc_html_e( 'Schema', 'wp-pilot-seo' ); ?></button>
				<button type="button" class="wppseo-tab" data-tab="advanced"><?php esc_html_e( 'Advanced', 'wp-pilot-seo' ); ?></button>
			</div>
			...
			<div class="wppseo-panel" data-panel="general">
				...
				<p><label><strong><?php esc_html_e( 'Focus keyword', 'wp-pilot-seo' ); ?></strong></label>
				<input type="text" id="wppseo-focus" name="wppseo[focus_kw]" value="<?php echo $focus; ?>" placeholder="<?php esc_attr_e( 'e.g. best water filter', 'wp-pilot-seo' ); ?>"></p>

				<p><label><strong><?php esc_html_e( 'SEO title', 'wp-pilot-seo' ); ?></strong>
				...
				<p><label><strong><?php esc_html_e( 'Meta description', 'wp-pilot-seo' ); ?></strong>
				...
				<p><label><strong><?php esc_html_e( 'Other keywords', 'wp-pilot-seo' ); ?></strong> <em>(<?php esc_html_e( 'comma separated', 'wp-pilot-seo' ); ?>)</em></label>
				...
				<div class="wppseo-score" id="wppseo-score">
					...
					<div class="wppseo-score-text"><?php esc_html_e( 'Enter a focus keyword to see your SEO score.', 'wp-pilot-seo' ); ?></div>
				</div>
				<ul class="wppseo-checks" id="wppseo-checks"></ul>
			</div>

			<div class="wppseo-panel" data-panel="social" hidden>
				<p><label><strong><?php esc_html_e( 'Social (OG) title', 'wp-pilot-seo' ); ?></strong></label>
				<input type="text" name="wppseo[og_title]" value="<?php echo $og_title; ?>" placeholder="<?php esc_attr_e( 'Defaults to SEO title', 'wp-pilot-seo' ); ?>"></p>
				<p><label><strong><?php esc_html_e( 'Social description', 'wp-pilot-seo' ); ?></strong></label>
				<textarea name="wppseo[og_desc]" rows="3" placeholder="<?php esc_attr_e( 'Defaults to meta description', 'wp-pilot-seo' ); ?>"><?php echo esc_textarea( $og_desc ); ?></textarea></p>
				<p><label><strong><?php esc_html_e( 'Social image URL', 'wp-pilot-seo' ); ?></strong></label>
				<input type="url" name="wppseo[og_image]" value="<?php echo $og_image; ?>" placeholder="<?php esc_attr_e( 'Defaults to featured image', 'wp-pilot-seo' ); ?>"></p>
			</div>

			<div class="wppseo-panel" data-panel="schema" hidden>
				<p><label><strong><?php esc_html_e( 'Schema type', 'wp-pilot-seo' ); ?></strong></label>
				...
				<p class="description"><?php esc_html_e( 'FAQ items can be managed via the AI assistant or REST API. Article, Breadcrumb & Organization schema are added automatically.', 'wp-pilot-seo' ); ?></p>
			</div>

			<div class="wppseo-panel" data-panel="advanced" hidden>
				<p><label><strong><?php esc_html_e( 'Canonical URL', 'wp-pilot-seo' ); ?></strong></label>
				<input type="url" name="wppseo[canonical]" value="<?php echo $canon; ?>" placeholder="<?php esc_attr_e( 'Leave blank for default', 'wp-pilot-seo' ); ?>"></p>
				<p><label><input type="checkbox" name="wppseo[noindex]" value="1" <?php checked( $noindex, '1' ); ?>> <strong><?php esc_html_e( 'Hide this page from search engines (noindex)', 'wp-pilot-seo' ); ?></strong></label></p>
			</div>
		</div>
		<?php
	}
